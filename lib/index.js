    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield axios_1.default
            ...
            try {
                ...
                animeStreamingLinkGogo = $('li.anime').children('a').attr('data-video');
                const downloadsLinkGogo = 'https://cors-anywhere.herokuapp.com/https:' + animeStreamingLinkGogo.replace('streaming.php', 'download');
                yield axios_1.default
